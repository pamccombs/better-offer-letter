        ...
        return (
            <MuiThemeProvider>
                <React.Fragment>
                    ...
                    <p>The success of (co_name) depends on the close collaboration of the talented people on our team.  And so I’m happy to invite you to join us as (nhire_title), reporting to (hman_first_name).</p>  
                    <p>Before I share the details of your offer, I want to help you understand how we arrive at compensation here at (co_name).</p>
                    ...
                    <p>Next, we look at normalized compensation data for roles similar to the one they will take on.  This data comes from salary databases, government benchmarks, and open job postings both at (co_name) and in the wider market.</p>
                    ...
                    <p>(OPTIONAL) Part of your compensation is also equity-based, which means you’ll directly own a portion of (co_name).  At our current market value, which is defined as (PUBLIC OR PRIVATE OR UNPRICED), this equity is worth (EQUITY) and you’ll receive it over the course of X years, every X months, so long as you continue to work at (co_name).  So you can think of it as worth about $X per year; as with your benefits, happy to chat through the details at any time.</p>
                    <p>Once you accept this offer, we’ll have to do some paperwork to do before you can begin working at (co_name).  But for the moment, let me end by thanking you.  I know how intense our application process is and I’m looking forward to the great good we will do together.  This will be work worth doing.</p>
